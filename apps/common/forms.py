...
class BasicSettingForm(BaseForm):
    SITE_URL = forms.URLField(
        ...
        widget=forms.TextInput(attrs={'placeholder': 'http://jumpserver.abc.com:8080'}),
...
class EmailSettingForm(BaseForm):
    EMAIL_HOST = forms.CharField(
        ...
        widget=forms.TextInput(attrs={'placeholder': 'smtp.jumpserver.org'})
    )
    ...
    EMAIL_HOST_USER = forms.CharField(
        ...
        widget=forms.TextInput(attrs={'placeholder': 'noreply@jumpserver.org'})
    )
    EMAIL_HOST_PASSWORD = FormEncryptCharField(
        max_length=1024, label=_("SMTP password"), 
...
class LDAPSettingForm(BaseForm):
    ...
    AUTH_LDAP_BIND_PASSWORD = FormEncryptCharField(
        label=_("Password"),
        widget=forms.PasswordInput(attrs={'placeholder': _("Password")}), required=False
    )
