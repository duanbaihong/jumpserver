...
class Config(dict):
    ...
    defaults = {
        ...
        'AUTH_LDAP_USER_ATTR_MAP': {"username": "uid", "name": "sn", "email": "mail", "role": "businessCategory", "phone": "mobile", "public_key": "sshPublickey", "comment": "description"},
        'AUTH_LDAP_GROUP_SEARCH_OU': None,
        'AUTH_LDAP_GROUP_TYPE_STRING': 'GroupOfUniqueNamesType',
        'AUTH_LDAP_GROUP_SEARCH_FILTER': '(|(objectclass=groupOfNames)(objectclass=groupOfUniqueNames)(objectclass=posixGroup))',
